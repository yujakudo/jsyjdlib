...
yjd.atm.rect = function(x,y,w,h) {
	if(!(this instanceof yjd.atm.rect)) {
		var rect = new yjd.atm.rect(x,y,w,h);
	}
	var context = this;
	if(typeof x!=='number') {
...
yjd.atm.rect.prototype.bottom = function(value) {
	...
	return this.org.bottom - this.y+this.h-1;
};
...
yjd.atm.rect.prototype.right = function(value) {
	...
	return this.org.right - this.x+this.w-1;
};
...
yjd.atm.getScreenRect = function(atm) {
	var scr = new yjd.atm.rect(0,0,window.screen.width,window.screen.height);
