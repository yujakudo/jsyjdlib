...
/**
 * @typedef yjd.ajax.Options
 * @desc Options for @see yjd.ajax
 * @property {string} [method='GET'] HTTP method. ex. 'GET', 'POST', 'PUT', 'DELETE'.
 * @property {string} url URL.
 * @property {boolean} [async=true] Asynchronous processing if true, or syncronous.
 * @property {string} [username] User name for BASIC authentication.
 * @property {string} [password] Password for BASIC authentication.
 * @property {string} [contentType='application/x-www-form-urlencoded; charset=UTF-8'] Content Type.
 * @property {Object} [headers] Additional HTTP headers. it has key:value pare.
 * @property {string|Object} [data] Request content to send. Object would be processed.
 * @property {boolean|function} [processData=ture] Encode data if ture.
 * @property {number} [timeout=0] timeout msec. if 0, it does not timeout.
 * @property {yjd.ajax.beforeSend} [beforeSend] Ths callback to be called before send.
 * @property {yjd.ajax.success} [success] Ths callback to be called when success.
 * @property {yjd.ajax.error} [error] Ths callback to be called when error occured.
 * @property {yjd.ajax.complete} [error] Ths callback to be called after success or error callback.
 * @property {boolean} [useThenCatch] use then catch model insted of done fail model and success error model.
 */
 ...
 *  timeout: 20 * 1000
 * }, this);</pre>
 * @param {yjd.ajax.Options|string}　options options or URL string.
