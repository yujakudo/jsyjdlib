 ...
 * @property {yjd.Sckey.code} [sckey] Code of short cut key.
 ...
 * @property {string} [place] Option to used only in yjd.wdg.Statusbar. 'left' or 'right', otherwise does not placed..
 */
/**
 * constructor of menu.
...
yjd.wdg.Menu = function(structure, options) {
	this.index = 'menu-' + yjd.getUniqueKey();
	this.data = {};
	this.sckey = {};
	this.mouseon = false;
...
yjd.wdg.prototype.destroy = function() {
    if(this.options.Sckey) this.options.Sckey.remove(this.index);
    this.unbindAll();
...
yjd.wdg.prototype.unbindAll = function() {
	...
	if(this.options.Sckey) {
		this.options.Sckey.remove(this.index);
	}
};
...
yjd.wdg.Menu.prototype.appendItems = function(structure, atmMenu, options) {
	...
	var pindex = parent? parent.data('idx'): this.index;
...
yjd.wdg.Menu.prototype.addSckey = function(menuAtm, options) {
	...
	this.options.Sckey.add(this.index, keydefs, options);
};
